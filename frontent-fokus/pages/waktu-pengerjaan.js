...
export default function WaktuPengerjaanChart() {
  ...
  }, [programId, jenis, token, title, module_name]);
  ...
  return (
    <div className="px-7 font-poppins mt-6">
      <div className="bg-white rounded-xl shadow px-5 pt-1">
