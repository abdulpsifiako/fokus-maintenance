...
import BulkUploadSection from "./BulkUploadSection"; // ← komponen baru
  ...
  return (
    <div className="p-6 space-y-8">
      ...
      <div className="flex justify-between items-center">
        ...
        {/* Tombol Batal & Simpan hanya tampil jika bukan mode bulk */}
        {!emailOnly && (
        ...
        {/* Jika emailOnly, Batal tetap tersedia */}
        {emailOnly && (
          <button
            onClick={onCancel}
            className="border border-primary text-primary px-4 py-2 rounded-md text-sm hover:bg-primary hover:text-white transition"
      ...
      {emailOnly ? (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          <div className="space-y-4">
            ...
            {/* ── BULK UPLOAD (hanya di emailOnly) ── */}
            <BulkUploadSection
          ...
          {/* Kolom kanan: Pilih program (untuk input email satu) */}
          <div>
                    ...
                    <div key={prog.id} className="flex items-center gap-3">
                      ...
                      {selected && (
                        <input
                          ...
                          className="w-20 px-2 py-1 text-sm border rounded focus:outline-primary"
                        />
                      )}
                    </div>
                  );
            ...
            {/* Tombol simpan satu email */}
            <button
              type="button"
              disabled={buttonDisabled}
              onClick={handleSubmit}
              className="mt-4 mb-5 bg-primary text-white px-4 py-2 rounded-md text-sm hover:bg-red-700 transition w-full"
            >
              Simpan
            </button>
          </div>
